...
Notes
The UI stores your Gemini API key in browser localStorage by default and sends it in request bodies. You can also set GEMINI_API_KEY in .env to keep it server-side only.
